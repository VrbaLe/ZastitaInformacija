...
{
    internal class FoursquareCipher : ICipherBehavior
    {
        ...
        public byte[] EncryptBytes(byte[] plaintextB)
        {
            ...
            for (int i = 0; i < plaintext.Length; i += 2)
            {
                ...
                if (position1 != null && position2 != null)
                {
                    char encryptedCh1 = keySquare1[position1.Item1, position2.Item2];
                    char encryptedCh2 = keySquare2[position2.Item1, position1.Item2];
        ...
        public byte[] DecryptBytes(byte[] ciphertextB)
        {
            ...
            for (int i = 0; i < ciphertext.Length; i += 2)
            {
                ...
                if (position1 != null && position2 != null)
                {
                    char decryptedCh1 = orderedAlphabet[position1.Item1, position2.Item2];
                    char decryptedCh2 = orderedAlphabet[position2.Item1, position1.Item2];
